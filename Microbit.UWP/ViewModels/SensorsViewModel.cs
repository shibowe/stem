...
namespace Microbit.UWP.ViewModels
{
    public class SensorsViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        private TemperatureSensorService tempSensor = null;

        protected void InitializeTemperatureSensor(GattDeviceService service)
        {
            tempSensor = new TemperatureSensorService(service);
        }
        ...
        private PressureSensorService presSensor = null;

        protected void InitializePressureSensor(GattDeviceService service)
        {
            presSensor = new PressureSensorService(service);
        }
        ...
        private AccelerationSensorService accSensor = null;

        protected async void InitializeAccelerationSensor(GattDeviceService service)
        {
            accSensor = new AccelerationSensorService(service);
