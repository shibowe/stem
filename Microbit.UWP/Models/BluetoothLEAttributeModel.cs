...
{
    public class BluetoothLEAttributeModel
    {
        ...
        public BluetoothLEAttributeModel(GattDeviceService service)
        {
            this.service = service;
            AttributeDisplayType = AttributeType.Service;
        }

        public BluetoothLEAttributeModel(GattCharacteristic characteristic)
        {
